...
const MOROCCAN_RECIPES: Recipe[] = [
  ...
  // ================= ASIE =================
  { id: 'poulet_teriyaki', name: { fr: 'Poulet teriyaki', ar: 'دجاجترياكي' }, emoji: '🍗', mealType: 'diner', tags: ['du_monde', 'proteine'], timeMin: 30, kcal: 520, protein: 34, carbs: 55, fat: 14, ingredients: [{ id: 'poulet', qtyPerPerson: 130 }, { id: 'riz', qtyPerPerson: 70 }, { id: 'sauce_soja', qtyPerPerson: 12 }, { id: 'miel', qtyPerPerson: 10 }, { id: 'gingembre', qtyPerPerson: 0.3 }, { id: 'ail', qtyPerPerson: 1 }, { id: 'brocoli', qtyPerPerson: 80 }], equipment: ['plaque'], vegetarian: false, pescetarian: false, glutenFree: false, lactoseFree: true, pregnancySafe: true, steps: [
    { fr: 'Faites cuire le riz (70 g/pers) dans 2 fois son volume d’eau, ~12 min.', ar: 'اطبخ الأرز (70غ/شخص) في ضعف حجمه ماءً لمدة 12 دقيقة تقريبا.' },
    { fr: 'Coupez le poulet (130 g/pers) en lanières ; râpez le gingembre et l’ail.', ar: 'قطّع الدجاج (130غ/شخص) شرائح، وابشر الزنجبيل والثوم.' },
    { fr: 'Mélangez sauce soja (12 ml/pers) + miel (10 g/pers) + ail + gingembre.', ar: 'اخلط صلصة الصويا (12مل/شخص) مع العسل (10غ/شخص) والثوم والزنجبيل.' },
    { fr: 'Saisissez le poulet 5–6 min à feu vif, versez la sauce et laissez glacer 2–3 min.', ar: 'اقلِ الدجاج 5–6 دقائق، أضف الصلصة واتركها تتكاثف 2–3 دقائق.' },
    { fr: 'Faites cuire le brocoli (80 g/pers) à la vapeur 5 min. Servez sur le riz.', ar: 'اطبخ البروكلي (80غ/شخص) على البخار 5 دقائق وقدّمه فوق الأرز.' },
  ] },
  ...
  { id: 'dahl_lentilles', name: { fr: 'Dahl de lentilles corail', ar: 'دال العدس الأحمر' }, emoji: '🍲', mealType: 'diner', tags: ['du_monde', 'healthy', 'vegetarien'], timeMin: 35, kcal: 460, protein: 18, carbs: 62, fat: 14, ingredients: [{ id: 'lentilles', qtyPerPerson: 90 }, { id: 'tomate_concassee', qtyPerPerson: 80 }, { id: 'oignon', qtyPerPerson: 0.5 }, { id: 'ail', qtyPerPerson: 1 }, { id: 'gingembre', qtyPerPerson: 0.3 }, { id: 'curcuma', qtyPerPerson: 2 }, { id: 'lait_coco', qtyPerPerson: 60 }, { id: 'riz', qtyPerPerson: 60 }], equipment: ['plaque'], vegetarian: true, pescetarian: true, glutenFree: true, lactoseFree: true, pregnancySafe: true, steps: [
    { fr: 'Rincez les lentilles corail (90 g/pers). Émincez l’oignon, l’ail et le gingembre.', ar: 'اغسل العدس الأحمر (90غ/شخص) وقطّع البصل والثوم والزنجبيل.' },
    { fr: 'Faites revenir oignon, ail, gingembre et curcuma (2 g/pers) 2 min dans un filet d’huile.', ar: 'قلّب البصل والثوم والزنجبيل والكركم (2غ/شخص) دقيقتين في قليل من الزيت.' },
    { fr: 'Ajoutez lentilles, tomates (80 g/pers), lait de coco (60 ml/pers) et 200 ml d’eau/pers.', ar: 'أضف العدس والطماطم (80غ/شخص) وحليب جوز الهند (60مل/شخص) و200مل ماء لكل شخص.' },
    { fr: 'Laissez mijoter 20–25 min jusqu’à ce que les lentilles soient fondantes.', ar: 'اتركه على نار هادئة 20–25 دقيقة حتى ينضج العدس.' },
    { fr: 'Servez avec le riz (60 g/pers) cuit à part.', ar: 'قدّمه مع الأرز (60غ/شخص) المطبوخ على حدة.' },
  ] },
  ...
  { id: 'ratatouille', name: { fr: 'Ratatouille', ar: 'راتاتوي' }, emoji: '🍆', mealType: 'diner', tags: ['healthy', 'du_monde', 'vegetarien'], timeMin: 45, kcal: 320, protein: 8, carbs: 35, fat: 16, ingredients: [{ id: 'aubergine', qtyPerPerson: 1 }, { id: 'courgette', qtyPerPerson: 1 }, { id: 'poivron', qtyPerPerson: 0.5 }, { id: 'tomate', qtyPerPerson: 2 }, { id: 'oignon', qtyPerPerson: 0.5 }, { id: 'ail', qtyPerPerson: 1 }, { id: 'huile_olive', qtyPerPerson: 14 }, { id: 'basilic', qtyPerPerson: 0.2 }], equipment: ['plaque'], vegetarian: true, pescetarian: true, glutenFree: true, lactoseFree: true, pregnancySafe: true, steps: [
    { fr: 'Coupez aubergine, courgette, poivron et tomates en cubes (~2 cm).', ar: 'قطّع الباذنجان والكوسة والفلفل والطماطم مكعبات (~2سم).' },
    { fr: 'Faites revenir l’oignon et l’ail 3 min dans l’huile d’olive (14 ml/pers).', ar: 'قلّب البصل والثوم 3 دقائق في زيت الزيتون (14مل/شخص).' },
    { fr: 'Ajoutez aubergine et courgette, faites dorer 8–10 min.', ar: 'أضف الباذنجان والكوسة وحمّرها 8–10 دقائق.' },
    { fr: 'Ajoutez poivron et tomates, salez, couvrez et laissez mijoter 20 min.', ar: 'أضف الفلفل والطماطم، ملّح، غطِّ واتركه ينضج 20 دقيقة.' },
    { fr: 'Parsemez de basilic ciselé avant de servir.', ar: 'زيّن بالحبق المفروم قبل التقديم.' },
  ] },
